...
const
  ...
  TRID_GET_DEF_ID = 100;
  // Get the id of the filetype's definition for a given result
  ...
  // DLL Functions
function TrID_Analyze: integer; stdcall;
  external 'tridlib.dll' name 'TrID_Analyze';
// Additional DLL function for the full version
function TrID_SetDefsPack(lDefsPtr: integer): integer; stdcall;
  external 'tridlib.dll' name 'TrID_SetDefsPack';
// Wrapped DLL functions
function TrID_SubmitFileA(szFileName: PAnsiChar): integer; stdcall;
  external 'tridlib.dll' name 'TrID_SubmitFileA';
function TrID_LoadDefsPack(szPath: PAnsiChar): integer; stdcall;
  external 'tridlib.dll' name 'TrID_LoadDefsPack';
function TrID_GetInfo(lInfoType: integer; lInfoIdx: integer; sBuf: PAnsiChar)
  : integer; stdcall; external 'tridlib.dll' name 'TrID_GetInfo';
...
function GetInfo(lInfoType: integer; lInfoIdx: integer;
  var sOut: string): integer;
